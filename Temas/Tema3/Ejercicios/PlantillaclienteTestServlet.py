...
def getUsername():
    if len(sys.argv) == 4:
        ...
        return "Parámetros incorrectos: type, email, password".decode("utf-8")
...
def registerMessage():
    if len(sys.argv) == 4:
        ...
        return "Parámetros incorrectos: type, username, message".decode("utf-8")
...
def getMessages():
    if len(sys.argv) == 3:
        ...
        return "Parámetros incorrectos: type, format".decode("utf-8")
...
if __name__ == "__main__":
    if len(sys.argv) == 1:
        ...
        print("  - registerMessage: type, email, message")
