...
String imagenURI = (String) request.getAttribute("imagenURI") + "?nocache=" + new Date().getTime();
%>
<html lang="es">
	<head>
...
<meta charset="utf-8">
	...
	<body>
		...
		<table  style="width:100%" class="edicion">
			...
			<tr class="edicion">
				<td class="edicion">
					<object class="edicion"
						data="<%=imagenURI%>" type="image/svg+xml">
					</object>
				</td>
	...
	<script>
		var elemento = document.getElementsByName("imagenSVG")[0];
